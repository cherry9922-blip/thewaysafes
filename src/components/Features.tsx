...
const features = [
  {
    ...
    description: "Family instantly informed during accidents with location details",
    category: "safety",
  },
  {
    icon: Bell,
    title: "Emergency Alerts",
    description: "Follow safety instructions immediately during emergencies",
    category: "safety",
  },
  {
    icon: Car,
    title: "Vehicle Risk Alert",
    description: "Get alerts during any vehicle emergency situations",
    category: "safety",
  },
  {
    icon: Shield,
    title: "Theft Alerts",
    description: "Real-time theft notifications to protect your vehicle",
    category: "security",
  },
  {
    icon: Truck,
    title: "Towing Alert",
    description: "Get notified instantly if your vehicle is being towed",
    category: "security",
  },
  {
    icon: Lock,
    title: "Lock Alert",
    description: "Reminder notification if vehicle is left unlocked",
    category: "security",
  },
  {
    icon: ParkingCircle,
    title: "Parking Alert",
    description: "Get notified about parking issues and violations instantly",
    category: "management",
  },
  {
    icon: FileText,
    title: "Store Documents",
    description: "RC, License, Insurance, PUC & more stored digitally",
    category: "management",
  },
  {
    icon: Flame,
    title: "Fire Alerts",
    description: "Immediate fire detection notifications to family",
    category: "safety",
  },
  {
    icon: Droplets,
    title: "Blood Bank",
    description: "Store blood group details for emergencies",
    category: "safety",
  },
  {
    icon: Users,
    title: "Family Notifications",
    description: "Add multiple family members to receive all alerts",
    category: "management",
  },
  {
    icon: Phone,
  ...
  },
  {
    ...
    description: "Share vehicle location during emergencies",
    category: "management",
  },
  {
    icon: Zap,
    title: "Instant Notifications",
    description: "Real-time push notifications for all alerts",
    category: "management",
  },
  {
    icon: Key,
    title: "Vehicle Details",
    description: "Store and manage all your vehicle information",
    category: "management",
  },
];
